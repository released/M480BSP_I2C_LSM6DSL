...
#line 12 "..\\I2C_LSM6DSL.h"
#line 13 "..\\I2C_LSM6DSL.h"
...
void I2C0_Init(void)	
{
    SYS_ResetModule(((4UL<<24) | (8)));

     
    I2C_Open((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL))), (100000));

    I2C_SetSlaveAddr((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL))), 0, (0xD6), 0);    

     
    printf("I2C clock %d Hz\n", I2C_GetBusClockFreq((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL)))));


    I2C_EnableInt((((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL))));
...
void UARTx_Process(void)
{
	...
	res = ((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->DAT);
...
{
    if((((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->INTSTS & ((0x1ul << (8)) | (0x1ul << (12))))?1:0))      
    {
        while(((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->FIFOSTS & (0x1ul << (14))) == 0)
        {
			UARTx_Process();
        }
    }

    if(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->FIFOSTS & ((0x1ul << (6)) | (0x1ul << (5)) | (0x1ul << (4)) | (0x1ul << (0))))
    {
        UART_ClearIntFlag(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)), ((0x1ul << (10))| (0x1ul << (13))));
    }
}
...
void UART0_Init(void)
{
	...
	UART_SetTimeoutCnt(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)), 20);

	((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->FIFO &= ~(0x1ul << (4));
	((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL))->FIFO |= (0x2ul << (4));

	 
	((((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x30000UL)))->INTEN |= ((0x1ul << (0)) | (0x1ul << (11)) | (0x1ul << (4))));
...
void TIMER1_HW_Init(void)
{
    ...
    CLK_SetModuleClock(((1UL<<30)|(1UL<<28) |(0x7UL<<25) |(12UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(3UL<<0)), (0x7UL << (12)), 0);
}

void TIMER1_Init(void)
{
    TIMER_Open(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10100UL)), (1UL << (27)), 1000);
...
void TIMER0_HW_Init(void)
{
	...
	CLK_SetModuleClock(((1UL<<30)|(1UL<<28) |(0x7UL<<25) |(8UL<<20) |(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(2UL<<0)), (0x2UL << (8)), 0);
}

void TIMER0_Polling(uint32_t u32Usec)
{
	TIMER_Delay(((TIMER_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x10000UL)), u32Usec);
}

void LED_Init(void)
{
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)),(0x00000001UL),0x1UL);
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x40000000) + 0x041C0UL)),(0x00000002UL),0x1UL);
...
void SYS_Init(void)
{
    ...
    CLK_EnableModuleClock(((0UL<<30)|(0x0UL<<28)|(0x0UL<<25)|(0x0UL<<20)|(0x0UL<<18)|(0x0UL<<10)|(0x0UL<<5)|(1UL<<0)));
    ...
    ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL = (((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->GPA_MFPL & ~((0xful << (20)) | (0xful << (16)))) |
                    ((0x09UL<<(16)) | (0x09UL<<(20)));
...
{	
    ...
    while(1)
    {
		...
		((*((volatile uint32_t *)(((((uint32_t)0x40000000) + 0x04800UL)+(0x40*(7))) + ((1)<<2))))) ^= 1;
