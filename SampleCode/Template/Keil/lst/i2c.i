...
uint32_t I2C_Open(I2C_T *i2c, uint32_t u32BusClock)
{
    ...
    if(i2c == ((I2C_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x41000UL)))
    {
...
void I2C_Close(I2C_T *i2c)
{
    ...
    if((uint32_t)i2c == ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x40000UL))
    {
        ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->IPRST1 |= (0x1ul << (8));
        ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->IPRST1 &= ~(0x1ul << (8));
    }
    else if((uint32_t)i2c == ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x41000UL))
    {
        ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->IPRST1 |= (0x1ul << (9));
        ((SYS_T *) (((uint32_t)0x40000000) + 0x00000UL))->IPRST1 &= ~(0x1ul << (9));
    }
...
uint32_t I2C_ReadMultiBytes(I2C_T *i2c, uint8_t u8SlaveAddr, uint8_t rdata[], uint32_t u32rLen)
{
    ...
    while(u8Xfering && (u8Err == 0u))
    {
        ...
        case 0x48u:                                              
            ...
            break;
        case 0x50u:
            rdata[u32rxLen++] = (unsigned char) ((i2c)->DAT);     
