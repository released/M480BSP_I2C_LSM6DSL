...
void appLSM6DSL_GetAcc(void)
{
	...
	do{
		appLSM6DSL_Read(((0xD6)), 0x1E, 1,&tmp);
		if (u8WaitCnt++>30)
			break;
	}while(!(tmp&( 1<<(0) )));


	appLSM6DSL_Read(((0xD6)), 0x10, 1,&tmp);
    tmp &= ((uint8_t)0x0C);
	...
	appLSM6DSL_Read(((0xD6)), 0x29, 1, &tmpxh);
	appLSM6DSL_Read(((0xD6)), 0x28, 1, &tmpxl);
	ax_s = ((int16_t) ((tmpxh << 8) | tmpxl));


	appLSM6DSL_Read(((0xD6)), 0x2B, 1, &tmpyh);
	appLSM6DSL_Read(((0xD6)), 0x2A, 1, &tmpyl);
	ay_s = ((int16_t) ((tmpyh << 8) | tmpyl));


	appLSM6DSL_Read(((0xD6)), 0x2D, 1, &tmpzh);
	appLSM6DSL_Read(((0xD6)), 0x2C, 1, &tmpzl);
...
void appLSM6DSL_GetGyro(void)
{
	...
	appLSM6DSL_Read(((0xD6)), 0x11, 1,&tmp);
    tmp &= ((uint8_t)0x0C);
	...
	appLSM6DSL_Read(((0xD6)), 0x23, 1, &tmpxh);
	appLSM6DSL_Read(((0xD6)), 0x22, 1, &tmpxl);
	gx_s = (((int16_t)(tmpxh << 8)) | ((int16_t)tmpxl));


	appLSM6DSL_Read(((0xD6)), 0x25, 1, &tmpyh);
	appLSM6DSL_Read(((0xD6)), 0x24, 1, &tmpyl);
	gy_s = (((int16_t)(tmpyh << 8)) | ((int16_t)tmpyl));


	appLSM6DSL_Read(((0xD6)), 0x27, 1, &tmpzh);
	appLSM6DSL_Read(((0xD6)), 0x26, 1, &tmpzl);
...
void appLSM6DSL_Set_IF_Addr_Incr(void)
{
	...
	appLSM6DSL_Read(((0xD6)), 0x12, 1,&value);
	value &= ~((uint8_t)0x04);
	value |= ((uint8_t)0x04);

	appLSM6DSL_Write(((0xD6)), 0x12, 1,&value);
}
...
void appLSM6DSL_Set_FIFO_MODE(void)
{
	...
	appLSM6DSL_Read(((0xD6)), 0x0A, 1,&value);
	value &= ~((uint8_t)0x07);
	value |= ((uint8_t)0x00);

	appLSM6DSL_Write(((0xD6)), 0x0A, 1,&value);
}
...
void appLSM6DSL_Set_ODR_G(void)
{
	...
	appLSM6DSL_Read(((0xD6)), 0x11, 1,&value);
	value &= ~((uint8_t)0xF0);
	value |= ((uint8_t)0x80);

	appLSM6DSL_Write(((0xD6)), 0x11, 1,&value);
}
...
void appLSM6DSL_Set_ODR_XL(void)
{
	...
	appLSM6DSL_Read(((0xD6)), 0x10, 1,&value);
	value &= ~((uint8_t)0xF0);
	value |= ((uint8_t)0x80);

	appLSM6DSL_Write(((0xD6)), 0x10, 1,&value);
}
...
void appLSM6DSL_SetACC(void)
{
	...
	appLSM6DSL_Read(((0xD6)), 0x0F, 1, &data);	
...
void Accelerator_Calibration(void)
{
	...
	if (Flag_Calibrate)
	{
		appLSM6DSL_SetAccCalData(AXIS_X,0);	
		...
		appLSM6DSL_SetAccCalData(AXIS_Y,0);		
		...
		appLSM6DSL_SetAccCalData(AXIS_Z,0);		
...
void Accelerator_filter(void)
{
	...
	ax_buf[(16) - 1] = appLSM6DSL_GetAccData(AXIS_X);
	ay_buf[(16) - 1] = appLSM6DSL_GetAccData(AXIS_Y);
	az_buf[(16) - 1] = appLSM6DSL_GetAccData(AXIS_Z);
...
void Gyroscope_filter(void)
{
	...
	gx_buf[(16) - 1] = appLSM6DSL_GetGyroData(AXIS_X);
	gy_buf[(16) - 1] = appLSM6DSL_GetGyroData(AXIS_Y);
	gz_buf[(16) - 1] = appLSM6DSL_GetGyroData(AXIS_Z);
