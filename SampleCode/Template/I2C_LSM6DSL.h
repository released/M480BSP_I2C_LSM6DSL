...
/* Includes ------------------------------------------------------------------*/
#ifndef __I2C_LSM6DSL_H
#define __I2C_LSM6DSL_H
...
#define ACC_ADDRESS                     					(LSM6DSL_ADDRESS)
#define GYRO_ADDRESS                    					(LSM6DSL_ADDRESS)
#define LSM6DSL_I2C_SPEED      								(100000)

#define I2C_SENSOR_PORT  									(MASTER_I2C)

typedef enum
{
	LSM6DSL_OK = 0,
	LSM6DSL_FAIL
}LSM6DSL_Status_TypDef;
...
/** @defgroup LSM6DSL_Exported_Constants
 * @{
 */
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_FUNC_CFG_ACCESS                                      0x01
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSOR_SYNC_TIME_FRAME                           0x04
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSOR_SYNC_ENABLE                             0x05
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FIFO_CTRL1                               0x06
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FIFO_CTRL2                               0x07
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FIFO_CTRL3                               0x08
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FIFO_CTRL4                               0x09
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FIFO_CTRL5                               0x0A
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_ORIENT_CFG_G                               0x0B
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_INT1_CTRL                                 0x0D
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_INT2_CTRL                                 0x0E
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_WHO_AM_I_ADDR                            0x0F
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_CTRL3_C                                  0x12
//new
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_CTRL4_C                                  0x13
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_CTRL5_C                                  0x14
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_CTRL10_C                                 0x19
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_MASTER_CONFIG                                 0x1A
...
/**
  ...
  * [1] X_WU: detection status on Y axis. Default value: 0
  * [0] X_WU: detection status on Z axis. Default value: 0
  * \endcode
*/
#define LSM6DSL_XG_WAKE_UP_SRC                                 0x1B
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_TAP_SRC                                    0x1C
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_D6D_SRC                                   0x1D
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_STATUS_REG                                  0x1E
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FIFO_STATUS1                                   0x3A
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FIFO_STATUS2                                  0x3B
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FIFO_STATUS3                                  0x3C
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FIFO_STATUS4                                  0x3D
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FIFO_DATA_OUT_L                                  0x3E
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FIFO_DATA_OUT_H                                  0x3F
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_TIMESTAMP0_REG                                  0x40
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_TIMESTAMP1_REG                                  0x41
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_TIMESTAMP2_REG                                  0x42
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_STEP_COUNTER_L                                  0x4B
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_STEP_COUNTER_H                                  0x4C
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_FUNC_SRC                                             0x53
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_TAP_CFG                                             0x58
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_TAP_THS_6D                                             0x59
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_INT_DUR2                                             0x5A
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_WAKE_UP_THS                                                   0x5B
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_WAKE_UP_DUR                                                   0x5C
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_WAKE_FREE_FALL                                                   0x5D
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_MD1_CFG                                                   0x5E
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_MD2_CFG                                                   0x5F
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB1_REG                       0x2E
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB2_REG                       0x2F
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB3_REG                       0x30
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB4_REG                       0x31
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB5_REG                       0x32
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB6_REG                       0x33
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB7_REG                       0x34
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB8_REG                       0x35
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB9_REG                       0x36
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB10_REG                       0x37
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB11_REG                       0x38
...
/**
  ...
  * \endcode
*/
#define  LSM6DSL_XG_SENSORHUB12_REG                       0x39
...
/**
  ...
  * \endcode
 */
#define LSM6DSL_XG_CTRL2_G                                  0x11
...
/**
  ...
  * \endcode
 */
#define LSM6DSL_XG_CTRL6_G                                  0x15
  ...
  * \endcode
 */
#define LSM6DSL_XG_CTRL7_G                                  0x16
...
/**
  ...
  * \endcode
 */
#define LSM6DSL_XG_OUT_X_L_G                                0x22
...
/**
  ...
  * \endcode
 */
#define LSM6DSL_XG_OUT_X_H_G                                0x23
 ...
 * \endcode
 */
#define LSM6DSL_XG_OUT_Y_L_G                                0x24
 ...
 * \endcode
 */
#define LSM6DSL_XG_OUT_Y_H_G                                0x25
 ...
 * \endcode
 */
#define LSM6DSL_XG_OUT_Z_L_G                                0x26
 ...
 * \endcode
 */
#define LSM6DSL_XG_OUT_Z_H_G                                0x27
 ...
 * \endcode
 */
#define LSM6DSL_XG_CTRL1_XL                                 0x10
  ...
  * \endcode
 */
#define LSM6DSL_XG_CTRL8_XL                                 0x17
...
/**
  ...
  * \endcode
*/
#define LSM6DSL_XG_CTRL9_XL                                	0x18
 ...
 * \endcode
 */
#define LSM6DSL_XG_OUT_X_L_XL                        		0x28
 ...
 * \endcode
 */
#define LSM6DSL_XG_OUT_X_H_XL                  				0x29
 ...
 * \endcode
 */
#define LSM6DSL_XG_OUT_Y_L_XL                          		0x2A
 ...
 * \endcode
 */
#define LSM6DSL_XG_OUT_Y_H_XL                          		0x2B
 ...
 * \endcode
 */
#define LSM6DSL_XG_OUT_Z_L_XL                          		0x2C
 ...
 * \endcode
 */
#define LSM6DSL_XG_OUT_Z_H_XL                       		0x2D
...
*/
#define LSM6DSL_ADDRESS_LOW                                 	0xD4    // SAD[0] = 0
#define LSM6DSL_ADDRESS_HIGH                                	0xD6    // SAD[0] = 1
#define LSM6DSL_XG_MEMS_ADDRESS                             	LSM6DSL_ADDRESS_LOW    // SAD[0] = 0


/**
 * @brief Device Identifier. Default value of the WHO_AM_I register.
 */
#define I_AM_LSM6DSL_XG                                 ((uint8_t)0x69)


/**
  * @brief  Register address automatically incremented during a multiple byte
  *         access with a serial interface (I2C or SPI). Default value of the
  *         LSM6DSL_XG_CTRL3_C register.
  */
#define LSM6DSL_XG_IF_INC                               ((uint8_t)0x04)

#define LSM6DSL_XG_IF_INC_MASK                          ((uint8_t)0x04)


#define LSM6DSL_ACC_GYRO_BDU_BLOCK_UPDATE      		(0x40)

#define LSM6DSL_ACC_GYRO_BDU_MASK   					(0x40)


#define LSM6DSL_ACC_GYRO_SW_RESET_RESET_DEVICE     	(0x01)

#define LSM6DSL_ACC_GYRO_SW_RESET_MASK    			(0x01)

/**
  * @brief  FIFO ODR selection FIFO_CTRL5
  */
#define LSM6DSL_XG_FIFO_ODR_NA                          ((uint8_t)0x00) /*!< FIFO ODR NA */
#define LSM6DSL_XG_FIFO_ODR_10HZ                        ((uint8_t)0x08) /*!< FIFO ODR 10Hz */
#define LSM6DSL_XG_FIFO_ODR_25HZ                        ((uint8_t)0x10) /*!< FIFO ODR 25Hz */
#define LSM6DSL_XG_FIFO_ODR_50HZ                        ((uint8_t)0x18) /*!< FIFO ODR 50Hz */
#define LSM6DSL_XG_FIFO_ODR_100HZ                       ((uint8_t)0x20) /*!< FIFO ODR 100Hz */
#define LSM6DSL_XG_FIFO_ODR_200HZ                       ((uint8_t)0x28) /*!< FIFO ODR 200Hz */
#define LSM6DSL_XG_FIFO_ODR_400HZ                       ((uint8_t)0x30) /*!< FIFO ODR 400Hz */
#define LSM6DSL_XG_FIFO_ODR_800HZ                       ((uint8_t)0x38) /*!< FIFO ODR 800Hz */
#define LSM6DSL_XG_FIFO_ODR_1600HZ                      ((uint8_t)0x40) /*!< FIFO ODR 1600Hz */
#define LSM6DSL_XG_FIFO_ODR_3300HZ                      ((uint8_t)0x48) /*!< FIFO ODR 3300Hz */
#define LSM6DSL_XG_FIFO_ODR_6600HZ                      ((uint8_t)0x50) /*!< FIFO ODR 6600Hz */

#define LSM6DSL_XG_FIFO_ODR_MASK                        ((uint8_t)0x78)


/**
  * @brief  FIFO mode selection FIFO_CTRL5
  */
#define LSM6DSL_XG_FIFO_MODE_BYPASS                     ((uint8_t)0x00) /*!< BYPASS Mode. FIFO turned off */
#define LSM6DSL_XG_FIFO_MODE_FIFO                       ((uint8_t)0x01) /*!< FIFO Mode. Stop collecting data when FIFO is full */
#define LSM6DSL_XG_FIFO_MODE_CONTINUOUS_THEN_FIFO       ((uint8_t)0x03) /*!< CONTINUOUS mode until trigger is deasserted, then FIFO mode */
#define LSM6DSL_XG_FIFO_MODE_BYPASS_THEN_CONTINUOUS     ((uint8_t)0x04) /*!< BYPASS mode until trigger is deasserted, then CONTINUOUS mode */
#define LSM6DSL_XG_FIFO_MODE_CONTINUOUS_OVERWRITE       ((uint8_t)0x05) /*!< CONTINUOUS mode. If the FIFO is full the new sample overwrite the older one */

#define LSM6DSL_XG_FIFO_MODE_MASK                       ((uint8_t)0x07)
...
/** @addtogroup LSM6DSL_XG Gyroscope Output Data Rate selection CTRL_REG1_G
 * @{
 */
#define LSM6DSL_G_ODR_PD                                ((uint8_t)0x00) /*!< Output Data Rate: Power-down*/
#define LSM6DSL_G_ODR_13HZ                              ((uint8_t)0x10) /*!< Output Data Rate: 13 Hz*/
#define LSM6DSL_G_ODR_26HZ                              ((uint8_t)0x20) /*!< Output Data Rate: 26 Hz*/
#define LSM6DSL_G_ODR_52HZ                              ((uint8_t)0x30) /*!< Output Data Rate: 52 Hz */
#define LSM6DSL_G_ODR_104HZ                             ((uint8_t)0x40) /*!< Output Data Rate: 104 Hz */
#define LSM6DSL_G_ODR_208HZ                             ((uint8_t)0x50) /*!< Output Data Rate: 208 Hz */
#define LSM6DSL_G_ODR_416HZ                             ((uint8_t)0x60) /*!< Output Data Rate: 416 Hz */
#define LSM6DSL_G_ODR_833HZ                             ((uint8_t)0x70) /*!< Output Data Rate: 833 Hz */
#define LSM6DSL_G_ODR_1K66HZ                            ((uint8_t)0x80) /*!< Output Data Rate: 1.66 kHz */

#define LSM6DSL_G_ODR_MASK                              ((uint8_t)0xF0)
...
/** @addtogroup LSM6DSL_XG Gyroscope Full scale selection CTRL2_G
 * @{
 */
#define LSM6DSL_G_FS_125                               ((uint8_t)0x02) /*!< Full scale: 125 dps*/
#define LSM6DSL_G_FS_245                               ((uint8_t)0x00) /*!< Full scale: 245 dps*/
#define LSM6DSL_G_FS_500                               ((uint8_t)0x04) /*!< Full scale: 500 dps */
#define LSM6DSL_G_FS_1000                              ((uint8_t)0x08) /*!< Full scale: 1000 dps */
#define LSM6DSL_G_FS_2000                              ((uint8_t)0x0C) /*!< Full scale: 2000 dps */

#define LSM6DSL_G_FS_MASK                              ((uint8_t)0x0C)

#define LSM6DSL_G_FS_125_SENSITIVITY                   	((float)4.375)
#define LSM6DSL_G_FS_245_SENSITIVITY                   	((float)8.75)
#define LSM6DSL_G_FS_500_SENSITIVITY                   	((float)17.50)
#define LSM6DSL_G_FS_1000_SENSITIVITY                 	((float)35)
#define LSM6DSL_G_FS_2000_SENSITIVITY                  	((float)70)
...
/** @addtogroup LSM6DSL_XG Gyroscope’s Z-axis output enable selection CTRL10_C
 * @{
 */
#define LSM6DSL_G_ZEN_DISABLE                          ((uint8_t)0x00) /*!< Gyroscope’s Z-axis output enable: disable */
#define LSM6DSL_G_ZEN_ENABLE                           ((uint8_t)0x20) /*!< Gyroscope’s Z-axis output enable: enable */

#define LSM6DSL_G_ZEN_MASK                             ((uint8_t)0x20)
...
/** @addtogroup LSM6DSL_XG Gyroscope’s Y-axis output enable selection CTRL10_C
 * @{
 */
#define LSM6DSL_G_YEN_DISABLE                          ((uint8_t)0x00) /*!< Gyroscope’s Y-axis output enable: disable */
#define LSM6DSL_G_YEN_ENABLE                           ((uint8_t)0x10) /*!< Gyroscope’s Y-axis output enable: enable */

#define LSM6DSL_G_YEN_MASK                             ((uint8_t)0x10)
...
/** @addtogroup LSM6DSL_XG Gyroscope’s X-axis output enable selection CTRL10_C
 * @{
 */
#define LSM6DSL_G_XEN_DISABLE                          ((uint8_t)0x00) /*!< Gyroscope’s X-axis output enable: disable */
#define LSM6DSL_G_XEN_ENABLE                           ((uint8_t)0x08) /*!< Gyroscope’s X-axis output enable: enable */

#define LSM6DSL_G_XEN_MASK                             ((uint8_t)0x08)
...
/** @addtogroup LSM6DSL_XG Accelerometer Output Data Rate selection CTRL1_XL
 * @{
 */
#define LSM6DSL_XL_ODR_PD                               ((uint8_t)0x00) /*!< Output Data Rate: Power-down*/
#define LSM6DSL_XL_ODR_13HZ                             ((uint8_t)0x10) /*!< Output Data Rate: 13 Hz*/
#define LSM6DSL_XL_ODR_26HZ                             ((uint8_t)0x20) /*!< Output Data Rate: 26 Hz*/
#define LSM6DSL_XL_ODR_52HZ                             ((uint8_t)0x30) /*!< Output Data Rate: 52 Hz */
#define LSM6DSL_XL_ODR_104HZ                            ((uint8_t)0x40) /*!< Output Data Rate: 104 Hz */
#define LSM6DSL_XL_ODR_208HZ                            ((uint8_t)0x50) /*!< Output Data Rate: 208 Hz */
#define LSM6DSL_XL_ODR_416HZ                            ((uint8_t)0x60) /*!< Output Data Rate: 416 Hz */
#define LSM6DSL_XL_ODR_833HZ                            ((uint8_t)0x70) /*!< Output Data Rate: 833 Hz */
#define LSM6DSL_XL_ODR_1K66HZ                           ((uint8_t)0x80) /*!< Output Data Rate: 1.66 kHz */
#define LSM6DSL_XL_ODR_3K33HZ                           ((uint8_t)0x90) /*!< Output Data Rate: 3.33 kHz */
#define LSM6DSL_XL_ODR_6K66HZ                           ((uint8_t)0xA0) /*!< Output Data Rate: 6.66 kHz */

#define LSM6DSL_XL_ODR_MASK                             ((uint8_t)0xF0)
...
/** @addtogroup LSM6DSL_XG Accelerometer Full scale selection CTRL1_XL
 * @{
 */
#define LSM6DSL_XL_FS_2G                                ((uint8_t)0x00) /*!< Full scale: +- 2g */
#define LSM6DSL_XL_FS_4G                                ((uint8_t)0x08) /*!< Full scale: +- 4g */
#define LSM6DSL_XL_FS_8G                                ((uint8_t)0x0C) /*!< Full scale: +- 8g */
#define LSM6DSL_XL_FS_16G                               ((uint8_t)0x04) /*!< Full scale: +- 16g */

#define LSM6DSL_XL_FS_MASK                              ((uint8_t)0x0C)

#define LSM6DSL_XL_FS_2G_SENSITIVITY                    ((float)0.061)
#define LSM6DSL_XL_FS_4G_SENSITIVITY                    ((float)0.122)
#define LSM6DSL_XL_FS_8G_SENSITIVITY                    ((float)0.244)
#define LSM6DSL_XL_FS_16G_SENSITIVITY                   ((float)0.488)
...
/** @addtogroup LSM6DSL_XG Accelerometer Anti-aliasing filter bandwidth selection CTRL1_XL
 * @{
 */
#define LSM6DSL_XL_BW_400HZ                             ((uint8_t)0x00) /*!< Anti-aliasing filter bandwidht: 400 Hz */
#define LSM6DSL_XL_BW_200HZ                             ((uint8_t)0x01) /*!< Anti-aliasing filter bandwidht: 200 Hz */
#define LSM6DSL_XL_BW_100HZ                             ((uint8_t)0x02) /*!< Anti-aliasing filter bandwidht: 100 Hz */
#define LSM6DSL_XL_BW_50HZ                              ((uint8_t)0x03) /*!< Anti-aliasing filter bandwidht: 50 Hz */

#define LSM6DSL_XL_BW_MASK                              ((uint8_t)0x03)
...
/** @addtogroup LSM6DSL_XG Accelerometer’s Z-axis output enable selection CTRL9_XL
 * @{
 */
#define LSM6DSL_XL_ZEN_DISABLE                          ((uint8_t)0x00) /*!< Accelerometer’s Z-axis output enable: disable */
#define LSM6DSL_XL_ZEN_ENABLE                           ((uint8_t)0x20) /*!< Accelerometer’s Z-axis output enable: enable */

#define LSM6DSL_XL_ZEN_MASK                             ((uint8_t)0x20)
...
/** @addtogroup LSM6DSL_XG Accelerometer’s Y-axis output enable selection CTRL9_XL
 * @{
 */
#define LSM6DSL_XL_YEN_DISABLE                          ((uint8_t)0x00) /*!< Accelerometer’s Y-axis output enable: disable */
#define LSM6DSL_XL_YEN_ENABLE                           ((uint8_t)0x10) /*!< Accelerometer’s Y-axis output enable: enable */

#define LSM6DSL_XL_YEN_MASK                             ((uint8_t)0x10)
...
/** @addtogroup LSM6DSL_XG Accelerometer’s X-axis output enable selection CTRL9_XL
 * @{
 */
#define LSM6DSL_XL_XEN_DISABLE                          	((uint8_t)0x00) /*!< Accelerometer’s X-axis output enable: disable */
#define LSM6DSL_XL_XEN_ENABLE                           	((uint8_t)0x08) /*!< Accelerometer’s X-axis output enable: enable */

#define LSM6DSL_XL_XEN_MASK                             	((uint8_t)0x08)

//#define LSM6DSL_XG_STATUS_REG                                0x27
