...
#line 9 "..\\..\\..\\Library\\StdDriver\\src\\pdma.c"


static uint8_t u32ChSelect[16UL];
...
void PDMA_SetTransferMode(PDMA_T * pdma,uint32_t u32Ch, uint32_t u32Peripheral, uint32_t u32ScatterEn, uint32_t u32DescAddr)
{
    ...
    case 7ul:
        ...
        break;
    case 8ul:
        pdma->REQSEL8_11 = (pdma->REQSEL8_11 & ~(0x7ful << (0))) | u32Peripheral;
        break;
    case 9ul:
        pdma->REQSEL8_11 = (pdma->REQSEL8_11 & ~(0x7ful << (8))) | (u32Peripheral << (8));
        break;
    case 10ul:
        pdma->REQSEL8_11 = (pdma->REQSEL8_11 & ~(0x7ful << (16))) | (u32Peripheral << (16));
        break;
    case 11ul:
        pdma->REQSEL8_11 = (pdma->REQSEL8_11 & ~(0x7ful << (24))) | (u32Peripheral << (24));
        break;
    case 12ul:
        pdma->REQSEL12_15 = (pdma->REQSEL12_15 & ~(0x7ful << (0))) | u32Peripheral;
        break;
    case 13ul:
        pdma->REQSEL12_15 = (pdma->REQSEL12_15 & ~(0x7ful << (8))) | (u32Peripheral << (8));
        break;
    case 14ul:
        pdma->REQSEL12_15 = (pdma->REQSEL12_15 & ~(0x7ful << (16))) | (u32Peripheral << (16));
        break;
    case 15ul:
        pdma->REQSEL12_15 = (pdma->REQSEL12_15 & ~(0x7ful << (24))) | (u32Peripheral << (24));
        break;
    default:
        break;
    }
    ...
    if(u32ScatterEn)
    {
        ...
        pdma->DSCT[u32Ch].NEXT = u32DescAddr - (((PDMA_T *) (((uint32_t)0x40000000) + 0x08000UL))->SCATBA);
    }
    else
    {
